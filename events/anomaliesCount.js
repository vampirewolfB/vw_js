...
//                         if (messageContent[0].toLowerCase() == "place:" && !isNaN(messageContent[1]))  {
//                             let data = `${message.author.username+'#'+message.author.discriminator};${messageContent[1]};${moment().format("HH:mm:ss")}`
//                             data = data.replace(/\n|\r/g, ' ')
